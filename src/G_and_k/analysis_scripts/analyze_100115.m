base_dir = '/home/mbergins/Documents/Projects/FRET-Processing/results/G and k data/100115_TV_GGS259/';

GGS_2 = struct();
GGS_2.FRET_files = file_search('.*c_pre.*',fullfile(base_dir,'tTVMod_GGS2_M/'),'return_complete_files',1);
GGS_2.Acceptor_files = file_search('^bsa_pre.*',fullfile(base_dir,'tTVMod_GGS2_M/'),'return_complete_files',1);
GGS_2.Donor_files = file_search('.*bsd_pre.*',fullfile(base_dir,'tTVMod_GGS2_M/'),'return_complete_files',1);
GGS_2.Mask_files = file_search('.*polymask_cells.*',fullfile(base_dir,'tTVMod_GGS2_M/'),'return_complete_files',1);

GGS_5 = struct();
GGS_5.FRET_files = file_search('.*c_pre.*',fullfile(base_dir,'tTVMod_GGS5_M/'),'return_complete_files',1);
GGS_5.Acceptor_files = file_search('^bsa_pre.*',fullfile(base_dir,'tTVMod_GGS5_M/'),'return_complete_files',1);
GGS_5.Donor_files = file_search('.*bsd_pre.*',fullfile(base_dir,'tTVMod_GGS5_M/'),'return_complete_files',1);
GGS_5.Mask_files = file_search('.*polymask_cells.*',fullfile(base_dir,'tTVMod_GGS5_M/'),'return_complete_files',1);

GGS_9 = struct();
GGS_9.FRET_files = file_search('.*c_pre.*',fullfile(base_dir,'tTVMod_GGS9_M/'),'return_complete_files',1);
GGS_9.Acceptor_files = file_search('^bsa_pre.*',fullfile(base_dir,'tTVMod_GGS9_M/'),'return_complete_files',1);
GGS_9.Donor_files = file_search('.*bsd_pre.*',fullfile(base_dir,'tTVMod_GGS9_M/'),'return_complete_files',1);
GGS_9.Mask_files = file_search('.*polymask_cells.*',fullfile(base_dir,'tTVMod_GGS9_M/'),'return_complete_files',1);
...
output_dir = '/home/mbergins/Documents/Projects/FRET-Processing/results/G and k data_analysis/10-1-15/';
